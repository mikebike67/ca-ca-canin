  ...
  return (
    <LegalPageShell locale={locale}>
      <div className="bg-brand-green-lighter px-4 py-16 text-gray-900 sm:px-6 lg:px-8">
        <section className="mx-auto max-w-3xl rounded-[2rem] border border-brand-border bg-white p-8 text-center shadow-brand-sm sm:p-10">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-full border border-brand-green px-6 py-3 text-sm font-semibold text-brand-green hover:bg-brand-green-light"
            >
