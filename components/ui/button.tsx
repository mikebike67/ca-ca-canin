...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-green disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-brand-green text-white shadow-brand-sm hover:bg-brand-green-dark",
        destructive:
          "bg-red-600 text-white shadow-sm hover:bg-red-700",
        outline:
          "border border-brand-green text-brand-green bg-white shadow-sm hover:bg-brand-green-light",
        secondary:
          "bg-brand-green-light text-brand-green shadow-sm hover:bg-brand-green-light/70",
        ghost: "hover:bg-brand-green-light hover:text-brand-green",
