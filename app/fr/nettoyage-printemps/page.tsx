...
export default function SpringCleanupFrenchPage() {
  ...
  return (
    <div lang="fr" className={`flex flex-col min-h-screen bg-white text-gray-900 ${montserrat.className}`}>
      ...
      <SiteHeader locale="fr" altHref="/spring-cleanup" ctaLabel="Obtenir un devis gratuit" />
      ...
      <main id="main-content" className="flex-grow scroll-mt-12 pt-16">
                      ...
                      {postalStatus === 'invalid' && (
                        <div className="text-sm text-red-600" role="status" aria-live="polite">
                          {postalCode && !isCanadianPostalCode(postalCode)
                            ...
                            : <>Désolé, ce code postal est hors de notre zone de service pour le nettoyage de printemps. Nous ne desservons pas votre secteur? <Link href="/fr/contact" className="font-semibold underline">Contactez-nous</Link>.</>}
                        </div>
                      )}
                    </div>
                    {postalStatus === 'valid' && (
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10 scroll-animation">
              ...
              <p className="text-lg text-gray-600">
                Service ponctuel de nettoyage printanier pour Laval et certaines villes de la Rive-Nord : Blainville, Boisbriand, Bois-des-Filion, Deux-Montagnes, Lorraine, Mirabel, Oka, Pointe-Calumet, Rosemère, Saint-Eustache, Saint-Joseph-du-Lac, Sainte-Anne-des-Plaines, Sainte-Marthe-sur-le-Lac et Sainte-Thérèse.
              </p>
            </div>
        ...
        {/* Cross-link to recurring service */}
        <section className="bg-[#eef7f0] px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <p className="mb-2 text-sm font-semibold uppercase tracking-widest text-brand-green">Service à l'année</p>
            <h2 className="mb-3 text-2xl font-bold text-gray-900">Vous cherchez un service régulier de ramassage?</h2>
            <p className="mb-6 text-gray-600">
              Après votre grand nettoyage printanier, gardez la cour propre semaine après semaine avec notre service récurrent.
            </p>
            <Link
              href="/fr/ramassage-dejections#quote-form"
