...
export default function SpringCleanupPage() {
  ...
  const handleBookingSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setPostalStatus('idle');
      setWebsiteField('');
      router.push('/thank-you?lang=en&type=spring');
    } catch (err: any) {
  ...
  return (
    <div className={`flex flex-col min-h-screen bg-white text-gray-900`}>
      ...
      <SiteHeader locale="en" altHref="/fr/nettoyage-printemps" ctaLabel="Get a Free Quote" />
      ...
      <main id="main-content" className="flex-grow scroll-mt-12 pt-16">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                ...
                <div className="flex flex-col gap-4 md:col-span-2">
                  ...
                  <form onSubmit={handleBookingSubmit} className="space-y-4 rounded-2xl border border-[#d7e6da] bg-white p-4 shadow-[0_18px_45px_rgba(17,24,39,0.05)]">
                    ...
                    {bookingStatus === 'success' && (
                      <div id="spring-quote-thank-you" tabIndex={-1} className="rounded-2xl border border-brand-green/20 bg-[#eef7f0] p-6 text-center shadow-[0_18px_45px_rgba(48,121,68,0.08)] outline-none">
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10 scroll-animation">
              ...
              <p className="text-lg text-gray-600">
                Serving Laval plus select North Shore cities for one-time spring dog waste cleanup: Blainville, Boisbriand, Bois-des-Filion, Deux-Montagnes, Lorraine, Mirabel, Oka, Pointe-Calumet, Rosemère, Saint-Eustache, Saint-Joseph-du-Lac, Sainte-Anne-des-Plaines, Sainte-Marthe-sur-le-Lac, and Sainte-Thérèse.
              </p>
            </div>
        ...
        <section className="bg-[#eef7f0] px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <p className="mb-2 text-sm font-semibold uppercase tracking-widest text-brand-green">Year-round service</p>
            <h2 className="mb-3 text-2xl font-bold text-gray-900">Looking for regular dog waste removal?</h2>
            <p className="mb-6 text-gray-600">
              After your spring reset, keep the yard clean week after week with our recurring pooper scooper service.
            </p>
            <Link
              href="/dog-poop-cleanup#quote-form"
