  ...
  return (
    <div className={`flex flex-col min-h-screen bg-white text-gray-900`}>
      ...
      <main id="main-content" className="flex-grow scroll-mt-12 pt-24">
        ...
        <section className="bg-brand-green-light px-4 pb-16 pt-12 sm:px-6 sm:pt-16 lg:px-8">
          <div className="max-w-7xl mx-auto">
        ...
        {/* Why Choose Us */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-brand-green">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 reveal-up">
        ...
        {/* CTA Banner */}
        <section className="bg-brand-green px-4 py-16 text-center sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto">
            ...
            <Button size="lg" className="rounded-full bg-white px-8 py-4 text-lg text-brand-green hover:bg-white/90" asChild>
              <Link href="#quote-form">Check Availability</Link>
            </Button>
          </div>
        </section>
